...
export default function ScrollingBanner() {
  return (
    <div
      role="banner"
      className="fixed bottom-0 left-0 right-0 bg-red-600 overflow-hidden z-0 h-48"
    >
      ...
      <div className="flex items-center justify-center h-full">
        <ScrollVelocity
          texts={['OMARPIOSELLI']}
          velocity={-50}
          className="text-[11rem] md:text-[12rem] lg:text-[14rem] font-bold text-black tracking-tighter leading-none"
