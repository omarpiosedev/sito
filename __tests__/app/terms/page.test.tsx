...
describe('TermsOfService Page', () => {
  ...
  describe('Content Structure and Sections', () => {
    ...
    it('renders section headings with correct styling', () => {
      ...
      const regularHeadings = sectionHeadings.filter(
        heading => !heading.textContent?.includes('10. Changes to Terms')
      );
    ...
    it('handles the typo in section 10 heading styling', () => {
      render(<TermsOfService />);
      const section10Heading = screen.getByRole('heading', {
  ...
  describe('Professional Services Section Content', () => {
    it('renders Project Engagement subsection with proper content', () => {
      ...
      expect(
        screen.getByRole('heading', { name: 'Project Engagement' })
      ).toBeInTheDocument();
      expect(
        screen.getByText('When engaging my professional development services:')
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          'All project terms will be defined in separate written agreements'
        )
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          'Pricing, timelines, and deliverables will be agreed upon before work begins'
        )
      ).toBeInTheDocument();
    });
    ...
    it('renders Professional Standards subsection with proper content', () => {
      ...
      expect(
        screen.getByRole('heading', { name: 'Professional Standards' })
      ).toBeInTheDocument();
      expect(screen.getByText('I commit to:')).toBeInTheDocument();
      expect(
        screen.getByText(
          'Delivering high-quality code following industry best practices'
        )
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          'Maintaining confidentiality of client information and projects'
        )
      ).toBeInTheDocument();
    });
    ...
    it('applies mt-6 class to Professional Standards heading', () => {
      render(<TermsOfService />);
      const professionalStandardsHeading = screen.getByRole('heading', {
  ...
  describe('Service Description Section', () => {
    ...
    it('renders service description with correct content', () => {
      ...
      expect(
        screen.getByText(
          /This website serves as a professional portfolio and business presence/
        )
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Omar Pioselli, a Full Stack Developer/)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Intellectual Property Section', () => {
    it('renders Website Content subsection', () => {
      ...
      expect(
        screen.getByRole('heading', { name: 'Website Content' })
      ).toBeInTheDocument();
      expect(
        screen.getByText(
    ...
    it('renders Project Work subsection', () => {
      ...
      expect(
        screen.getByRole('heading', { name: 'Project Work' })
      ).toBeInTheDocument();
      expect(screen.getByText('For development projects:')).toBeInTheDocument();
      expect(
        screen.getByText(
          'Client retains rights to their business logic and proprietary content'
        )
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          'Custom code developed for specific client needs belongs to the client upon full payment'
        )
      ).toBeInTheDocument();
    });
    ...
    it('applies mt-6 class to Project Work heading', () => {
      render(<TermsOfService />);
      const projectWorkHeading = screen.getByRole('heading', {
        name: 'Project Work',
      });
  ...
  describe('Disclaimers Section', () => {
    it('renders all disclaimer subsections', () => {
      ...
      expect(
        screen.getByRole('heading', { name: 'Website Disclaimer' })
      ).toBeInTheDocument();
      expect(
        screen.getByRole('heading', {
          name: 'Professional Services Disclaimer',
        })
      ).toBeInTheDocument();
      expect(
    ...
    it('renders Professional Services Disclaimer content', () => {
      ...
      expect(
        screen.getByText('Ongoing maintenance and updates may be required')
      ).toBeInTheDocument();
    });

    it('applies mt-6 class to subsection headings in disclaimers', () => {
      render(<TermsOfService />);
      const professionalDisclaimerHeading = screen.getByRole('heading', {
        name: 'Professional Services Disclaimer',
      });
      const limitationHeading = screen.getByRole('heading', {
  ...
  describe('Links and External References', () => {
    ...
    it('renders LinkedIn link with correct attributes', () => {
      ...
      const linkedinLink = screen.getByRole('link', {
        name: 'linkedin.com/in/omarpioselli',
      });
  ...
  describe('Contact Information Section', () => {
    ...
    it('renders complete contact information', () => {
      ...
      expect(
        screen.getByText('LinkedIn:', { exact: false })
      ).toBeInTheDocument();
    });
  ...
  describe('Legal Content Validation', () => {
    it('contains expected terms of service content', () => {
      ...
      expect(
        screen.getByText(
          /By accessing and using this website \(omarpioselli\.dev\)/
        )
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Terms of Service \("Terms"\)/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/governed by the laws of Italy/)
      ).toBeInTheDocument();
    });
    ...
    it('renders indemnification clause', () => {
      ...
      expect(
        screen.getByText(
          /You agree to indemnify and hold harmless Omar Pioselli/
        )
      ).toBeInTheDocument();
      expect(
        screen.getByText(/reasonable attorneys' fees/)
      ).toBeInTheDocument();
    });
    ...
    it('renders termination clause', () => {
      ...
      expect(
        screen.getByText(
          /For professional service engagements, termination terms/
        )
      ).toBeInTheDocument();
    });
    ...
    it('renders governing law information', () => {
      ...
      expect(
        screen.getByText(/jurisdiction of the courts of Como, Italy/)
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Code Coverage Edge Cases', () => {
    ...
    it('renders complete agreement to terms content', () => {
      ...
      expect(
        screen.getByText(/accept and agree to be bound by the terms/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/If you do not agree to abide by the above/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Your continued use of the website following/)
      ).toBeInTheDocument();
    });
    ...
    it('renders complete privacy and data protection content', () => {
      ...
      expect(
        screen.getByText(/Your privacy is important to me/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/For development projects, data protection terms/)
      ).toBeInTheDocument();
    ...
    it('renders complete limitation of liability content', () => {
      ...
      expect(
        screen.getByText(/In no event shall Omar Pioselli be liable/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/special, indirect, or consequential damages/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/loss of use, data, or profits/)
      ).toBeInTheDocument();
    });
    ...
    it('renders complete changes to terms content', () => {
      ...
      expect(
        screen.getByText(/I reserve the right to modify these terms/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(/Changes will be posted on this page/)
      ).toBeInTheDocument();
      expect(
        screen.getByText(
          /For significant changes, I will make reasonable efforts/
        )
      ).toBeInTheDocument();
    });
  ...
  describe('Complete Content Coverage', () => {
    it('renders all expected content from each major section', () => {
      ...
      expect(
        screen.getByText(/third party due to or arising out of/)
      ).toBeInTheDocument();
    });
  });
});
