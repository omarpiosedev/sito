...
describe('CookiePolicy Page', () => {
  ...
  describe('Content Structure and Sections', () => {
    ...
    it('renders cookie type cards with correct structure', () => {
      ...
      cookieTypes.forEach(cookieType => {
        ...
        expect(heading).toHaveClass('text-xl', 'font-medium', 'text-white', 'mb-3', 'flex', 'items-center');
      });
    });
  ...
  describe('Cookie Table', () => {
    it('renders the cookie information table', () => {
      ...
      expect(table).toHaveClass('w-full', 'border-collapse', 'border', 'border-gray-700', 'text-sm');
    });
    ...
    it('renders specific cookie entries', () => {
      ...
      const cookieNames = ['_ga', '_ga_*', '_gid', 'next-session', 'theme-preference'];
  ...
  describe('Third-Party Services', () => {
    it('renders Google Analytics section', () => {
      ...
      expect(screen.getByText('Website analytics and performance monitoring')).toBeInTheDocument();
    });

    it('renders Social Media Platforms section', () => {
      render(<CookiePolicy />);
      
      expect(screen.getByRole('heading', { name: 'Social Media Platforms' })).toBeInTheDocument();
      expect(screen.getByText('LinkedIn, Instagram, Freelancer')).toBeInTheDocument();
    });
    ...
    it('renders external links with correct attributes', () => {
      ...
      const optOutLink = screen.getByRole('link', { name: 'Google Analytics Opt-out Browser Add-on' });
  ...
  describe('Browser Instructions', () => {
    ...
    it('renders warning message about disabling cookies', () => {
      ...
      expect(screen.getByText(/Disabling certain cookies may affect the functionality/)).toBeInTheDocument();
    });
  });
  ...
  describe('Contact Information', () => {
    it('renders contact information section', () => {
      ...
      expect(screen.getByText('Omar Pioselli', { selector: 'strong' })).toBeInTheDocument();
    ...
    it('renders email link with correct attributes', () => {
      ...
      const emailLink = screen.getByRole('link', { name: 'omarpioselli.dev@gmail.com' });
      expect(emailLink).toHaveAttribute('href', 'mailto:omarpioselli.dev@gmail.com');
  ...
  describe('Related Policies', () => {
    ...
    it('renders links to privacy policy and terms of service', () => {
      ...
      expect(termsLink).toHaveClass('text-red-400', 'hover:text-red-300', 'underline');
    });
  });
  ...
  describe('Responsive Design', () => {
    ...
    it('applies responsive grid classes to browser instructions', () => {
      render(<CookiePolicy />);
      const browserGrid = document.querySelector('.grid-cols-1.md\\:grid-cols-2');
